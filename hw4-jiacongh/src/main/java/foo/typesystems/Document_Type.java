...
/* First created by JCasGen Fri Oct 25 16:32:53 EDT 2013 */
...
/** 
 * Updated by JCasGen Fri Oct 25 16:32:53 EDT 2013
 * @generated */
public class Document_Type extends Annotation_Type {
  ...
  /** @generated */
  final Feature casFeat_tokenNum;
  /** @generated */
  final int     casFeatCode_tokenNum;
  /** @generated */ 
  public int getTokenNum(int addr) {
        if (featOkTst && casFeat_tokenNum == null)
      jcas.throwFeatMissing("tokenNum", "foo.typesystems.Document");
    return ll_cas.ll_getIntValue(addr, casFeatCode_tokenNum);
  }
  /** @generated */    
  public void setTokenNum(int addr, int v) {
        if (featOkTst && casFeat_tokenNum == null)
      jcas.throwFeatMissing("tokenNum", "foo.typesystems.Document");
    ll_cas.ll_setIntValue(addr, casFeatCode_tokenNum, v);}
  ...
  public Document_Type(JCas jcas, Type casType) {
    ...
    casFeat_tokenNum = jcas.getRequiredFeatureDE(casType, "tokenNum", "uima.cas.Integer", featOkTst);
    casFeatCode_tokenNum  = (null == casFeat_tokenNum) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_tokenNum).getCode();
