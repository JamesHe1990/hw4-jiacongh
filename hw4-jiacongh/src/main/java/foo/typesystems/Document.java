 ...
 * XML source: C:/Users/James_He/git/hw4-jiacongh/hw4-jiacongh/src/main/resources/descriptors/typesystems/VectorSpaceTypes.xml
 * @generated */
public class Document extends Annotation {
  ...
  /** getter for tokenNum - gets 
   * @generated */
  public int getTokenNum() {
    if (Document_Type.featOkTst && ((Document_Type)jcasType).casFeat_tokenNum == null)
      jcasType.jcas.throwFeatMissing("tokenNum", "foo.typesystems.Document");
    return jcasType.ll_cas.ll_getIntValue(addr, ((Document_Type)jcasType).casFeatCode_tokenNum);}
    
  /** setter for tokenNum - sets  
   * @generated */
  public void setTokenNum(int v) {
    if (Document_Type.featOkTst && ((Document_Type)jcasType).casFeat_tokenNum == null)
      jcasType.jcas.throwFeatMissing("tokenNum", "foo.typesystems.Document");
    jcasType.ll_cas.ll_setIntValue(addr, ((Document_Type)jcasType).casFeatCode_tokenNum, v);}    
  }
